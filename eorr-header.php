<form method="post" autocomplete="off" enctype="multipart/form-data" name="searchForm" id="searchForm" data-ng-model="searchForm" novalidate data-ng-controller="vkationcontroller">
		...
		<div class="row" style="margin: 0;padding: 0;border-bottom: 2px solid #dce0e0;">
			<div class="col-lg-12 col-xm-12 col-md-12 col-sm-12" style="margin:0px; padding:0px;">
				...
				<div class="col-lg-10 col-xm-10 col-md-10 col-sm-10 eorr-header-right text-right">
					<input id="place" name="place" data-ng-modal="place" class="col-lg-3 col-xm-3 col-md-3 col-sm-3 custom-selector" style="border-right:0;" required value="<?php echo $_SESSION['place']; ?>">
					<!--<div class="col-lg-5 col-xm-5 col-md-5 col-sm-5" style="padding:0;"></div>-->
					<ul>
