...
<html lang="en">
	<head>
		...
		<script src="js/angularjs/log-script.js"></script>
	</head>
				...
				<div id="login" class="animate form">
					<section class="login_content">
						...
						<form autocomplete="off" enctype="multipart/form-data" name="ULoginForm" ng-submit="submitData(ULogin)" novalidate>
							<h1>Login</h1>
							<div>
								<input type="text" required autofocus placeholder="Username." maxlength="25" name="username" class="form-control" id="username" ng-model="ULogin.username" ng-minlength="2" ng-maxlength="20" />
								<div class="error" ng-show="ULoginForm.username.$dirty && ULoginForm.username.$invalid">
									...
									<small class="error" ng-show="ULoginForm.username.$error.minlength">Username is required to be at least 2 characters</small>
									<small class="error" ng-show="ULoginForm.username.$error.maxlength">Username cannot be longer than 4 characters</small>
								</div>								
								<p>&nbsp;</p>
							</div>
							<div>
								<input type="password" required placeholder="Password" maxlength="20" name="password" class="form-control" id="Password" ng-model="ULogin.password" ng-minlength="7" ng-maxlength="20" />
								<div class="error" ng-show="ULoginForm.password.$dirty && ULoginForm.password.$invalid">
									...
									<small class="error" ng-show="ULoginForm.password.$error.minlength">Password is required to be at least 7 characters</small>
...
{
	echo "<script language=\"javascript\">window.location=\"welcome\";</script>";
}
?>
