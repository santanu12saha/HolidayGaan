						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_content">
									...
									<form class="form-horizontal form-label-left" ng-show="editform" id="PropertyForm" autocomplete="off" enctype="multipart/form-data" name="PropertyForm" method="post">
										...
										<div class="form-group">
											<div class="col-sm-12" style="padding: 0px 10px 0px 0px;">
												...
												<label><input type="checkbox" id="safetycard" ng-checked="c_safetycard()" ng-model="safetycard" />&nbsp Safety Card &nbsp;</label>&nbsp;&nbsp;
									...
									<form class="form-horizontal form-label-left" ng-show="view" id="PropertyForm" autocomplete="off" enctype="multipart/form-data" name="PropertyForm" method="post">
										<div class="form-group">
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<input type="hidden"  class="form-control" disabled="" ng-model="id" name="id" />
												<label for="pname">Property Name</label><br />
												<input type="text" class="form-control" ng-readonly="true" ng-model="pname" placeholder="Property Name" id="pname" name="pname" required  />
												<div class="error" ng-show="PropertyForm.pname.$dirty && PropertyForm.pname.$invalid">
														<small class="error" ng-show="PropertyForm.pname.$error.required">Name is required.</small>											
												</div>
											</div>
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;" >
												<label for="paddress">Address</label>
												<textarea class="form-control" placeholder="Property Address" ng-readonly="true" ng-model="paddress" name="paddress" id="paddress" required></textarea>
												<div class="error" ng-show="PropertyForm.paddress.$dirty && PropertyForm.paddress.$invalid">
														<small class="error" ng-show="PropertyForm.paddress.$error.required">Property Address is required.</small>											
												</div>
											</div>
										...
										<div class="form-group">
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="conno">Contact Number</label>
												<input type="text" class="form-control" ng-model="conno" ng-readonly="true" placeholder="Contact Number" id="conno" name="conno" required  />
												<div class="error" ng-show="PropertyForm.conno.$dirty && PropertyForm.conno.$invalid">
														<small class="error" ng-show="PropertyForm.conno.$error.required">Contact number is required.</small>											
												</div>	
											</div>
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="location">Location</label>
												<input type="text" class="form-control" ng-model="location" ng-readonly="true" placeholder="Location" id="location" name="location" required  />
												<div class="error" ng-show="PropertyForm.location.$dirty && PropertyForm.location.$invalid">
														<small class="error" ng-show="PropertyForm.location.$error.required">Location is required.</small>											
												</div>	
											</div>
										...
										<div class="form-group">
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="conno">Property Type</label>
												<select  class="form-control"  name="property_type" id="property_type" ng-readonly="true" ng-model="property_type" ng-init="getptype()" required>
													<option value="">Select Property Type</option>
													<option ng-repeat="propertyTypes in propertyType" value="{{propertyTypes.package_name}}">{{propertyTypes.package_name}}</option>	
												</select>	
											</div>
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="busstation">Bus Station (Distance)</label>
												<input type="text" class="form-control" ng-model="busstation" ng-readonly="true" placeholder="Bus Station" id="busstation" name="busstation" required  />
												<div class="error" ng-show="PropertyForm.busstation.$dirty && PropertyForm.busstation.$invalid">
														<small class="error" ng-show="PropertyForm.busstation.$error.required">Bus Station is required.</small>											
												</div>	
											</div>
										...
										<div class="form-group">
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="railwaystation">Railway Station (Distance)</label>
												<input type="text" class="form-control" ng-model="railwaystation" ng-readonly="true" placeholder="Railway Station" id="railwaystation" name="railwaystation" required  />
												<div class="error" ng-show="PropertyForm.railwaystation.$dirty && PropertyForm.railwaystation.$invalid">
														<small class="error" ng-show="PropertyForm.railwaystation.$error.required">Railway Station is required.</small>											
												</div>	
											</div>
											...
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="airport">Airport(Distance)</label>
												<input type="text" class="form-control" ng-model="airport" ng-readonly="true" placeholder="Airport" id="airport" name="airport" required  />
												<div class="error" ng-show="PropertyForm.airport.$dirty && PropertyForm.airport.$invalid">
														<small class="error" ng-show="PropertyForm.airport.$error.required">Airport Station is required.</small>											
												</div>	
											</div>
										...
										<div class="form-group">
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="description">Description</label>
												<textarea class="form-control" placeholder="Description" ng-readonly="true" ng-model="description" name="description" id="description" required></textarea>
												<div class="error" ng-show="PropertyForm.description.$dirty && PropertyForm.description.$invalid">
													<small class="error" ng-show="PropertyForm.description.$error.required">Description is required.</small>											
												</div>
											</div>
										...
										<div class="form-group">
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="latitude">Latitude</label>
												<input  type="text"  class="form-control" placeholder="Latitude" ng-readonly="true" ng-model="latitude" required name="latitude" id="latitude"  />
												<div class="error" ng-show="PropertyForm.latitude.$dirty && PropertyForm.latitude.$invalid">
													<small class="error" ng-show="PropertyForm.latitude.$error.required">Latitude is required.</small>											
												</div>
											</div>
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="longitude">Longitude</label>
												<input  type="text"  class="form-control" placeholder="Longitude" ng-readonly="true" ng-model="longitude" required name="longitude" id="longitude" />
												<div class="error" ng-show="PropertyForm.longitude.$dirty && PropertyForm.longitude.$invalid">
													<small class="error" ng-show="PropertyForm.longitude.$error.required">Longitude is required.</small>											
												</div>		
											</div>	
										...
										<div class="form-group">
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="rating">Rating</label>
												<input  type="text"  class="form-control" placeholder="Rating" ng-readonly="true" ng-model="rating" required name="rating" id="rating" min="0" max="5"/>
												<div class="error" ng-show="PropertyForm.rating.$dirty && PropertyForm.rating.$invalid">
													<small class="error" ng-show="PropertyForm.rating.$error.required">Rating is required.</small>											
												</div>
											</div>
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="tripaddrating">Trip Advisor Rating</label>
												<input  type="text"  class="form-control" ng-readonly="true" placeholder="Trip Advisor Rating" ng-model="tripaddrating" required name="tripaddrating" id="tripaddrating" min="0" max="5"/>
												<div class="error" ng-show="PropertyForm.tripaddrating.$dirty && PropertyForm.tripaddrating.$invalid">
													<small class="error" ng-show="PropertyForm.tripaddrating.$error.required">Trip Advisor Rating is required.</small>											
												</div>		
											</div>	
										...
										<div class="form-group">
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="extraperson">Extra Person</label>
												<input  type="text"  class="form-control" placeholder="Rate" ng-readonly="true" ng-model="extraperson" required name="extraperson" id="extraperson"/>
												<div class="error" ng-show="PropertyForm.extraperson.$dirty && PropertyForm.extraperson.$invalid">
													<small class="error" ng-show="PropertyForm.extraperson.$error.required">Extra Person rate is Required</small>											
												</div>
											</div>
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="child">Child</label>
												<input  type="text"  class="form-control" placeholder="Rate" ng-readonly="true" ng-model="child" required name="child" id="child" />
												<div class="error" ng-show="PropertyForm.child.$dirty && PropertyForm.child.$invalid">
													<small class="error" ng-show="PropertyForm.child.$error.required">Child rate is Required</small>											
												</div>		
											</div>	
										...
										<div class="form-group">
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label for="propertypicture">Property Pictures</label>
                                                <input type="file" id="propertypicture" name="propertypicture" ng-readonly="true" ng-model="propertypicture" multiple >
												<div class="error" ng-show="PropertyForm.propertypicture.$dirty && PropertyForm.propertypicture.$invalid">
													<small class="error" ng-show="PropertyForm.propertypicture.$error.required">Property Pictures is Required</small>											
												</div>
											</div>
											<div class="col-sm-6" style="padding: 0px 10px 0px 0px;">
												<label  for="cancellingpolicy">Cancelling Policy</label>
												<textarea class="form-control" placeholder="Cancelling Policy" ng-readonly="true" ng-model="cancellingpolicy" name="cancellingpolicy" id="cancellingpolicy" required></textarea>
												<div class="error" ng-show="PropertyForm.cancellingpolicy.$dirty && PropertyForm.cancellingpolicy.$invalid">
													<small class="error" ng-show="PropertyForm.cancellingpolicy.$error.required">Cancelling Policy is required.</small>											
												</div>
											</div>
										...
										<div class="form-group">
											<div class="col-sm-12" style="padding: 0px 10px 0px 0px;">
												<label class="control-label" for="Instantbook" style="padding:3px 0;">Instant Booking &nbsp;&nbsp;</label>
												<span style="display:block;height:0;">&nbsp;</span>
												<label><input type="checkbox" id="instantbooking" ng-disabled="true" ng-checked="c_instantbooking()" ng-model="instantbooking" />&nbsp Instant Booking&nbsp;</label>&nbsp;&nbsp;	
											</div>
										</div>	
										...
										<div class="form-group">
											<div class="col-sm-12" style="padding: 0px 10px 0px 0px;">
												<label class="control-label" for="Configuration" style="padding:3px 0;">Facilities/Amenities&nbsp;&nbsp;</label>
												<span style="display:block;height:0;">&nbsp;</span>
												<label><input type="checkbox" id="wifi" ng-disabled="true" ng-checked="c_wifi()" ng-model="wifi" />&nbsp Wireless Internet&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="tv" ng-disabled="true" ng-checked="c_tv()" ng-model="tv" />&nbsp TV &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="kitchen" ng-disabled="true" ng-checked="c_kitchen()" ng-model="kitchen" />&nbsp Kitchen &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="checkin" ng-disabled="true" ng-checked="c_checkin()" ng-model="checkin" />&nbsp 24 Hour Check - In &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="safetycard" ng-disabled="true" ng-checked="c_safetycard()" ng-model="safetycard" />&nbsp Safety Card &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="indoorgame" ng-disabled="true" ng-checked="c_indoorgame()" ng-model="indoorgame" />&nbsp Indoor Games &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="cabletv" ng-disabled="true" ng-checked="c_cabletv()" ng-model="cabletv" />&nbsp Cable TV &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="smokingallowed" ng-disabled="true" ng-checked="c_smokingallowed()" ng-model="smokingallowed" />&nbsp Smoking Allowed &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="outdoorgame" ng-disabled="true" ng-checked="c_outdoorgame()" ng-model="outdoorgame" />&nbsp Outdoor Games &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="gym" ng-disabled="true" ng-checked="c_gym()" ng-model="gym" />&nbsp Gym &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="wheelchair" ng-disabled="true" ng-checked="c_wheelchair()" ng-model="wheelchair" />&nbsp Wheelchair Accessible&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="kidsplayarea" ng-disabled="true" ng-checked="c_kidsplayarea()" ng-model="kidsplayarea" />&nbsp Kids Play Area&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="heating" ng-disabled="true" ng-checked="c_heating()" ng-model="heating" />&nbsp Heating&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="breakfast" ng-disabled="true" ng-checked="c_breakfast()" ng-model="breakfast" />&nbsp Breakfast&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="yoga" ng-disabled="true" ng-checked="c_yoga()" ng-model="yoga" />&nbsp Yoga&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="internet" ng-disabled="true" ng-checked="c_internet()" ng-model="internet" />&nbsp Internet&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="wiintercom" ng-disabled="true" ng-checked="c_wiintercom()" ng-model="wiintercom" />&nbsp Wireless Intercom&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="ac" ng-disabled="true" ng-checked="c_ac()" ng-model="ac" />&nbsp Air Conditioning &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="freeparking" ng-disabled="true" ng-checked="c_freeparking()" ng-model="freeparking" />&nbsp Free Parking &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="swimmingpool" ng-disabled="true" ng-checked="c_swimmingpool()" ng-model="swimmingpool" />&nbsp Swimming Pool &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="petsallowed" ng-disabled="true" ng-checked="c_petsallowed()" ng-model="petsallowed" />&nbsp Pets Allowed &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="barnrestro" ng-disabled="true" ng-checked="c_barnrestro()" ng-model="barnrestro" />&nbsp Bar & Restaurant &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="roomservice" ng-disabled="true" ng-checked="c_roomservice()" ng-model="roomservice" />&nbsp Room Service &nbsp;</label>
												<label><input type="checkbox" id="busscenter" ng-disabled="true" ng-checked="c_busscenter()" ng-model="busscenter" />&nbsp Business Centre &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="lounge" ng-disabled="true" ng-checked="c_lounge()" ng-model="lounge" />&nbsp Lounge &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="conferencehall" ng-disabled="true" ng-checked="c_conferencehall()" ng-model="conferencehall" />&nbsp Conference Hall &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="shopping" ng-disabled="true" ng-checked="c_shopping()" ng-model="shopping" />&nbsp Shopping&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="ayurvedacenter" ng-disabled="true" ng-checked="c_ayurvedacenter()" ng-model="ayurvedacenter" />&nbsp Ayurveda Centre&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="laundry" ng-disabled="true" ng-checked="c_laundry()" ng-model="laundry" />&nbsp Laundry &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="security" ng-disabled="true" ng-checked="c_security()" ng-model="security" />&nbsp 24 Hour Security &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="airporttrasport" ng-disabled="true" ng-checked="c_airporttrasport()" ng-model="airporttrasport" />&nbsp Airport Transport&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="atminresort" ng-disabled="true" ng-checked="c_atminresort()" ng-model="atminresort" />&nbsp ATM / BANK in Resort&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="hotcoldwater" ng-disabled="true" ng-checked="c_hotcoldwater()" ng-model="hotcoldwater" />&nbsp Hot / Cold Running Water&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="firstaidkit" ng-disabled="true" ng-checked="c_firstaidkit()" ng-model="firstaidkit" />&nbsp First Aid Kit &nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="hairdryer" ng-disabled="true" ng-checked="c_hairdryer()" ng-model="hairdryer" />&nbsp Hair Dryer&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="hottub" ng-disabled="true" ng-checked="c_hottub()" ng-model="hottub" />&nbsp Hot Tub&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="suitableforwvent" ng-disabled="true" ng-checked="c_suitableforwvent()" ng-model="suitableforwvent" />&nbsp Suitable for Events&nbsp;</label>&nbsp;&nbsp;
												
												<label><input type="checkbox" id="spa" ng-disabled="true" ng-checked="c_spa()" ng-model="spa" />&nbsp spa&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="jacuzzi" ng-disabled="true" ng-checked="c_jacuzzi()" ng-model="jacuzzi" />&nbsp Jacuzzi&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="finedinig" ng-disabled="true" ng-checked="c_finedinig()" ng-model="finedinig" />&nbsp Fine Dinig&nbsp;</label>&nbsp;&nbsp;
												<label><input type="checkbox" id="caffe" ng-disabled="true" ng-checked="c_caffe()" ng-model="caffe" />&nbsp Caffe&nbsp;</label>&nbsp;&nbsp;
									...
									<div ng-show="list">						 
										<div class="form-group">
											...
											<div class="col-sm-3" style="padding: 0px 10px 0px 0px;">
												 <p class="pull-right"><a class="btn btn-success btn-sm" href="addproperty"  ng-click="add_table()"><i class="fa fa-plus"></i> Add</a>&nbsp;&nbsp;&nbsp;</p>
											</div>
										</div>
										...
										<table border=1 class="table table-striped table-condensed table-hover">
											...
											<tbody ng-init="get_preop()">
												<tr dir-paginate="Counseling in pagedItems|itemsPerPage:15">
													<td>{{ $index+1 }}</td>
													<td>{{ Counseling.pname }}</td>
													<td>{{ Counseling.p_add}}</td>
													<td>{{ Counseling.rating }}</td>
													<td>{{ Counseling.tripadvisorrating }}</td>
													<td><a ng-click="edit_tproperty(Counseling.id)">Edit</a> | <a ng-click="view_tproperty(Counseling.id)">View</a> | <a ng-click="delete_tpproperty(Counseling.id)">Delete</a></td>
												</tr>
											</tbody>	
											<tfoot>
												<tr>
