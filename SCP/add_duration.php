...
<html lang="en">
	...
	<body class="nav-md" ng-app="Myapp" ng-cloak>
		<div class="container body" ng-controller="durationController">
			<!-- Sidebar Starts Here -->
				...
				<div class="">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<h4 class="mb"><i class="fa fa-plus"></i> Add Duration</h4>
								<div class="x_content">
									<form class="form-horizontal style-form" method="post" name="addduration" autocomplete="off" enctype="multipart/form-data" >
										<div class="form-group">
											...
											<div class="col-sm-6">
												...
												<textarea class="form-control" placeholder="Duration Detail." ng-model="detail" name="detail"></textarea> 
											</div>
										</div>  
										...
										<button  class="btn btn-success" onclick="window.location.href='list_duration';"/>Back</button>	
										</div>
										</div>
