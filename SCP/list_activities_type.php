								...
								<div class="x_content">
									...
									<form class="form-horizontal form-label-left" id="ProForm" name="ProForm" ng-show="view" novalidate >
										...
										<div class="form-group">
											...
											<div class="col-sm-6" >
												<label  for="Name">Activity Type</label>
												<input  type="text"  class="form-control" ng-readonly="true" placeholder="Activity Name" required name="Name" id="Name" ng-model="Name"  />
												<div class="error" ng-show="ProForm.Name.$dirty && ProForm.bgroup.$invalid">
													<small class="error" ng-show="ProForm.Name.$error.required">Name is required.</small>											
												</div>
											</div>
											<div class="col-sm-6" >
												<label  for="Name">Description</label>
												<input  type="text"  class="form-control" ng-readonly="true" placeholder="Description" required name="Description" id="Description" ng-model="Description"  />
												<div class="error" ng-show="PForm.Name.$dirty && PForm.bgroup.$invalid">
													<small class="error" ng-show="PForm.Name.$error.required">Name is required.</small>											
												</div>
											</div>
									...
									<div ng-show="list">
										<p class="pull-right"><a class="btn btn-success btn-sm" href="activity_type" ng-show='btn_pat' ng-click="add_cataract()"><i class="fa fa-plus"></i> Add</a>&nbsp;&nbsp;&nbsp;</p>
										</p>	
