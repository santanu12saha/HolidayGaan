...
<html lang="en">
	<head>
		...
		<!-- AngularJS Script Starts Here -->
			...
			<script src="js/angularjs/property_type.js"></script>
				...
				<div class="">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_content">
									<form class="form-horizontal form-label-left" id="ProForm" name="ProForm" ng-show="view_preop1" novalidate >
										...
										<div class="form-group">
											...
											<button  class="btn btn-success" onclick="window.location.href='list_property_type';"/>Back</button>	
										</div>

										</div>
									</form>
									
									<form class="form-horizontal form-label-left" id="ProForm" name="ProForm" ng-show="view" novalidate >
										<div class="form-group">
												<input type="hidden"  class="form-control" disabled="" ng-model="id" name="id" />
											<div class="col-sm-6" >
												<label  for="Name">Property Type</label>
												<input  type="text" ng-readonly="true" class="form-control" placeholder="Property Name" required name="Name" id="Name" ng-model="Name"  />
												<div class="error" ng-show="ProForm.Name.$dirty && ProForm.bgroup.$invalid">
													<small class="error" ng-show="ProForm.Name.$error.required">Name is required.</small>											
												</div>
											</div>
											<div class="col-sm-6" >
												<label  for="Name">Description</label>
												<input  type="text" ng-readonly="true"   class="form-control" placeholder="Description" required name="Description" id="Description" ng-model="Description"  />
												<div class="error" ng-show="PForm.Name.$dirty && PForm.bgroup.$invalid">
													<small class="error" ng-show="PForm.Name.$error.required">Name is required.</small>											
												</div>
											</div>
									...
									<div ng-show="list">
										<p class="pull-right"><a class="btn btn-success btn-sm" href="property_type" ng-show='btn_pat' ng-click="add_cataract()"><i class="fa fa-plus"></i> Add</a>&nbsp;&nbsp;&nbsp;</p>
										</p>	
